...
mainMenu.create = function () {
    ...
    //buttons
    btnStart = this.add.image(game.canvas.width/2, game.canvas.height/2, 'startButton').setInteractive().setScale(0.5);
    btnOptions = this.add.image(game.canvas.width/2, game.canvas.height/2 + 125, 'optionsButton').setInteractive().setScale(0.5);
