...
<div class="d-flex flex-column">
  <div class="d-flex justify-content-center">
    <div class="d-flex justify-content-center align-middle text-center" id="form-modal">
      <form action="gantiNama" method="POST">
          ...
          <div class="form-floating">
            <input type="text" class="form-control" id="floatingInput" name="nama" value=<?= $data[0]['nama']; ?>>
            <label for="floatingInput">Nama</label>
          </div>
          <br>
          <div class="form-floating">
            <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="email" disabled >
