...
<body>
      <h3 style="position: fixed; left:850px;">REKAP SISWA/I</h3>
...
<div class="">
    <label>Tingkat</label>
            <select class="form-select" aria-label="Default select example" name="tingkat" onchange="this.form.submit()">
              <option value=10 <?php if(isset($_GET['tingkat']) && $_GET['tingkat']==10){echo 'selected';} ?>>X</option>
              <option value=11 <?php if(isset($_GET['tingkat']) && $_GET['tingkat']==11){echo 'selected';} ?>>XI</option>
              <option value=12 <?php if(isset($_GET['tingkat']) && $_GET['tingkat']==12){echo 'selected';} ?>>XII</option>
            </select>
          </div>
</form>
