...
<html lang="en">
  ...
  <?php
    ...
    $pos+=30;}?>
      ...
      <a href="find" class="navButton" style="left:800px"><i style="padding:33px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
      ...
      </svg></i><br>Play game</a>
      <a href="logout" class="navButton" style="left:1000px"><i style="padding:20px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
